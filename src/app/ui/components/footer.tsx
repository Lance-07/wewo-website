...
export default function Footer() {
    return (
        <footer className={'w-full sm:h-[448px] relative'}>
            ...
            <div className={'~px-2/0 ~py-4/0 relative flex flex-col items-center justify-center h-full w-full'}>
                ...
                <div className={'text-white flex-col flex items-center text-center gap-4'}>
                    <h1 className={'~text-2xl/4xl font-bold'}>Collect. Conserve. Recycle.</h1>
            ...
            <div className="relative bg-[#202020] text-white/70 h-11 flex items-center text-center justify-center">
