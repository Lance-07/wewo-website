    ...
    return (
        <button {...props} className={cn(
            ...
            <div className={cn(
                ...
                {
                    "bg-gradient-to-r from-[#84A6EE] to-[#87EB6F] from-[7%] to-100% opacity-20": background && active && variant === 'gradient',
            ...
            <div className={cn(
                ...
                {
                    'bg-gradient-to-r from-[#4A6BB3] to-[#4A7F3B] bg-clip-text text-transparent ': active && variant=== 'gradient',
                    'bg-gradient-to-r from-[#4A6BB3] to-[#4A7F3B] text-transparent bg-clip-text ': active && border && variant=== 'gradient',
