...
export function CardSkeleton() {
  return (
    <div
      className={`${shimmer} flex gap-2 rounded-lg p-2 flex-col shadow-card-shadow w-[280px] sm:w-[320px] md:w-[240px] lg:w-[270px] h-[150px] md:h-[187px] animate-pulse bg-gray-100`}
    >
...
export function PieSkeleton() {
  return (
    <div
      className={`${shimmer} bg-gray-100 shadow-card-shadow gap-4 p-4 flex rounded-lg w-full h-[291px]`}
    >
...
export function BackwashIndSkeleton() {
  return (
    <div
      className={`${shimmer} bg-gray-100 flex gap-4 flex-col p-4 w-full h-[291px] shadow-card-shadow rounded-lg`}
    >
...
export function BottleBinIndSkeleton() {
  return (
    <div
      className={`${shimmer} bg-gray-100 w-full h-[291px] p-4 gap-4 shadow-card-shadow rounded-lg flex flex-col`}
    >
...
export function WaterStatusSkeleton() {
  return (
    <div
      className={`fixed bottom-4 z-40 right-4 sm:right-9 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-slate-200 shadow-md ${shimmer} animate-pulse`}
    ></div>
  );
}
